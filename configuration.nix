...

{
  ...
  services.displayManager.autoLogin.user = "mao";
...
#  serviceConfig = {
#    ExecStart = "${pkgs.v2raya}/bin/v2raya --log-file /var/log/v2raya.log";
#    Restart = "always";
#    User = "v2raya";
#    Group = "v2raya";
#  };
#};
  ...
  networking.firewall.allowedTCPPorts = [ 1080 2017 443 80 7890 7891 ];
